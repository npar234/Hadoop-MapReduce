...
public class CrawlerThread extends Thread {
    ...
    public void crawlU(String id) throws IOException, InterruptedException {
	boolean loop = true;
	int pageNumber = 1;
    ...
    public void crawlP(String id) throws IOException, InterruptedException {
	boolean loop = true;
	int pageNumber = 1;
